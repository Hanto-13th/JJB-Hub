...
urlpatterns = [
    ...
    path("home/ranking", views.ranking_club, name="ranking"),
    path("home/ranking/club_settings", views.club_settings, name="club_settings"),
    path("home/ranking/club_settings/check", views.checkbox_admin, name="checkbox_admin"),
